...
const sections = [
    {
        ...
        content: (
            <>
                ...
                <p className="text-2xl font-light font-display text-black dark:text-white tracking-widest italic">190€</p>
            </>
        ),
    },
    {
        ...
        content: (
            <div className="space-y-8 text-black dark:text-white">
                ...
                <a
                    ...
                    className="inline-flex items-center space-x-3 text-black dark:text-white border-b border-black/10 dark:border-white/10 pb-2 hover:border-black dark:hover:border-white transition-all group cursor-pointer"
                >
    ...
    return (
        <main className="max-w-4xl mx-auto px-6 py-20 md:py-32">
            ...
            >
                ...
                <div className="w-12 h-px bg-black/10 dark:bg-white/10 mx-auto" />
            </motion.header>
