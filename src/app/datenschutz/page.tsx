        ...
        <main className="max-w-3xl mx-auto px-6 py-24 font-sans">
            ...
            >
                ...
                <div className="space-y-12 text-gray-600 font-light leading-relaxed">
                    <section>
                        <h2 className="text-primary font-medium uppercase tracking-widest text-[10px] mb-6">1. Datenschutz auf einen Blick</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-primary font-medium uppercase tracking-widest text-[10px] mb-6">2. Hosting und Server-Logfiles</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-primary font-medium uppercase tracking-widest text-[10px] mb-6">3. Ihre Rechte</h2>
                        <p>
